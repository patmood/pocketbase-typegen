...
export type EverythingRelationMappings<Trest extends string = ""> = {
...
export type EverythingExpand<T extends string> =
...
export type MyViewRelationMappings<Trest extends string = ""> = {
	"post_relation_field"?: PostsResponse<Trest>
}

export type MyViewExpand<T extends string> =
	T extends `${infer F},${infer R}`
...
export type PostsRelationMappings<Trest extends string = ""> = {
	"tags"?: TagsResponse<Trest>[]
}

export type PostsExpand<T extends string> =
	T extends `${infer F},${infer R}`
...
export type TagsRelationMappings<Trest extends string = ""> = {
	"images": ImagesResponse<Trest>[]
}

export type TagsExpand<T extends string> =
	T extends `${infer F},${infer R}`
